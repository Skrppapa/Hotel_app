...
from src.schemas.facility import RoomFacility
...
class RoomsFacilitiesRepository(BaseRepository):
    ...
    async def set_room_facility(self, room_id: int, facilities_id: list[int]) -> None:
        ...
        if ids_to_insert:
            insert_m2m_facilities_stmt = (
                insert(self.model)
                #.values(room_id=room_id, facility_id=ids_to_insert)
